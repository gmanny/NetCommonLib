...
namespace Monitor.ServiceCommon.Services.Json
{
    ...
    public class CumulativeThreadsafeConverter : JsonConverter
    {
        ...
        private static readonly ConcurrentDictionary<JsonSerializer, CumulativeThreadsafeConverter> pairings = new ConcurrentDictionary<JsonSerializer, CumulativeThreadsafeConverter>();
