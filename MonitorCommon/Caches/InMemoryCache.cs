...
namespace MonitorCommon.Caches
{
    ...
    {
        private readonly Dictionary<TKey, (TValue value, LinkedListNode<TimeBox<TKey>> listNode)> cache = new Dictionary<TKey, (TValue value, LinkedListNode<TimeBox<TKey>> listNode)>();
        private readonly LinkedList<TimeBox<TKey>> usageTimes = new LinkedList<TimeBox<TKey>>();
